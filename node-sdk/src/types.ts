// Type definitions for GraphNight Node.js SDK
...
export interface GraphNightClientConfig {
  url?: string; // For GraphQL server mode (not used in local mode)
  storagePath?: string; // For local YAML storage
  headers?: Record<string, string>; // For GraphQL server auth
